...
// curatedChannelModels is the model catalog shown by the channel editor.
// Keep this deployment intentionally small: operators can still add custom
// model names in the editor, while the suggestion list only contains the
// models stocked by this instance.
var curatedChannelModels = []dto.OpenAIModels{
	{Id: "gpt-5.5", Object: "model", Created: 1626777600, OwnedBy: "openai"},
	{Id: "gpt-5.6-sol", Object: "model", Created: 1626777600, OwnedBy: "openai"},
	{Id: "gpt-5.6-terra", Object: "model", Created: 1626777600, OwnedBy: "openai"},
	{Id: "gpt-5.6-luna", Object: "model", Created: 1626777600, OwnedBy: "openai"},
	{Id: "gpt-5.4", Object: "model", Created: 1626777600, OwnedBy: "openai"},
}
