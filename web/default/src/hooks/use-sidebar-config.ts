...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/operational-costs': { section: 'admin', module: 'operational_costs' },
  '/token-sales': { section: 'admin', module: 'token_sales' },
  '/token-sales/keys': { section: 'admin', module: 'token_sales' },
  '/token-sales/transactions': { section: 'admin', module: 'token_sales' },
  '/token-sales/overview': { section: 'admin', module: 'token_sales' },
